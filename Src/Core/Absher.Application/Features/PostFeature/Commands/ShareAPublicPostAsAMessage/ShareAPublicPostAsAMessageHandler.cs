...
{
    public class ShareAPublicPostAsAMessageHandler : IRequestHandler<ShareAPublicPostAsAMessageCommand, ResponseResult<bool>>
    {
        public async Task<ResponseResult<bool>> Handle(ShareAPublicPostAsAMessageCommand request, CancellationToken cancellationToken)
        {
